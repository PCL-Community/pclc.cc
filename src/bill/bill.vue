...
<template>
    <div style="flex-direction: row; display: flex;">
        ...
        <div class="outlay-bill">
            <p style="text-align: center; padding-top: 6px; margin: 0px; width: auto; height: auto;"> 支出：￥{{ Math.round(BillManager.getoutlays() * 100) / 100 }} </p>
        </div>
    </div>
    
    <div class="bill-border">
        <div v-for="bill in bills" class="bill">
            <svg v-if="bill.type === 'outlay'" width="28" height="28" style="scale: 150%; margin-top: 11px;" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
